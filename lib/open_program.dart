                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Expanded(child: Text(activeProgram.weeks[sliderIndex].name, style: Styles.labelText.copyWith(fontSize: 27))),
...
class DayWidgetState extends State<DayWidget> {
  ...
  @override
  Widget build(BuildContext context) {
    day currentDay = widget.currentProgram.weeks[widget.weekIndex].days[widget.dayIndex];
        ...
        child: Row(
          ...
          children: [
            InkWell(
                ...
                child: const Column(
                  children: [
                    Icon(Icons.add_box, color: Colors.white, size: 35),
                    Text("Create", style: Styles.smallTextWhite),
                  ],
                )),
            InkWell(
                onTap: () {
                ...
                child: const Column(
                  children: [
                    Icon(Icons.content_paste_go, color: Colors.white, size: 35),
                    Text("Paste", style: Styles.smallTextWhite),
                  ],
                )),
          ],
        ),
